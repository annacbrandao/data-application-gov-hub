...
def api_executor_especial_dag() -> None:
    ...
    def fetch_and_store_executores_especiais() -> None:
        logging.info(
            "[executores_especiais_ingest_dag.py] Iniciando "
            "extração massiva de executores especiais"
        )
        ...
        if executores_data and len(executores_data) > 0:
            ...
            logging.warning(
                "[executores_especiais_ingest_dag.py] "
                "Nenhum executor especial encontrado na API"
            )
