...
with
    executor_especial_raw as (
        select
            ...
            ind_recursos_gerenciados_conta_especifica_executor::text
            as ind_recursos_gerenciados_conta_especifica_executor,
            codigo_banco_executor::text as codigo_banco_executor,
            nome_banco_executor::text as nome_banco_executor,
            nullif(numero_agencia_executor, 'NaN')::numeric::integer
            as numero_agencia_executor,
            ...
            nullif(codigo_situacao_dado_bancario_executor, 'NaN')::numeric::integer
            as codigo_situacao_dado_bancario_executor,
            descricao_situacao_dado_bancario_executor::text
            as descricao_situacao_dado_bancario_executor,
