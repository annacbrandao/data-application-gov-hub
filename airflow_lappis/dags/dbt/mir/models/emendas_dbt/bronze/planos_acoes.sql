...
with
    planos_raw as (
        select
            ...
            nullif(
                codigo_situacao_dado_bancario_plano_acao::numeric, 'NaN'::numeric
            )::integer as codigo_situacao_dado_bancario_plano_acao,
            nome_banco_plano_acao::text as nome_banco_plano_acao,
            nullif(numero_agencia_plano_acao::numeric, 'NaN'::numeric)::integer
            as numero_agencia_plano_acao,
            dv_agencia_plano_acao::text as dv_agencia_plano_acao,
            nullif(numero_conta_plano_acao::numeric, 'NaN'::numeric)::integer
            as numero_conta_plano_acao,
            dv_conta_plano_acao::text as dv_conta_plano_acao,
            nome_parlamentar_emenda_plano_acao::text
            as nome_parlamentar_emenda_plano_acao,
            ano_emenda_parlamentar_plano_acao::text as ano_emenda_parlamentar_plano_acao,
            codigo_parlamentar_emenda_plano_acao::text
            as codigo_parlamentar_emenda_plano_acao,
            sequencial_emenda_parlamentar_plano_acao::integer
            as sequencial_emenda_parlamentar_plano_acao,
            numero_emenda_parlamentar_plano_acao::text
            as numero_emenda_parlamentar_plano_acao,
            codigo_emenda_parlamentar_formatado_plano_acao::text
            as codigo_emenda_parlamentar_formatado_plano_acao,
            codigo_descricao_areas_politicas_publicas_plano_acao::text
            as codigo_descricao_areas_politicas_publicas_plano_acao,
            descricao_programacao_orcamentaria_plano_acao::text
            as descricao_programacao_orcamentaria_plano_acao,
            ...
            valor_investimento_plano_acao::numeric(
                15, 2
            ) as valor_investimento_plano_acao,
