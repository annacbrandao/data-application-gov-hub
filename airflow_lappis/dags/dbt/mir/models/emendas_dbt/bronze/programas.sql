...
with
    programas_raw as (
        select
            ...
            as id_unidade_orcamentaria_responsavel_programa,
            ...
            valor_necessidade_financeira_programa::numeric(
                15, 2
            ) as valor_necessidade_financeira_programa,
            valor_total_disponibilizado_programa::numeric(
                15, 2
            ) as valor_total_disponibilizado_programa,
            valor_impedido_programa::numeric(15, 2) as valor_impedido_programa,
            valor_a_disponibilizar_programa::numeric(
                15, 2
            ) as valor_a_disponibilizar_programa,
            valor_documentos_habeis_gerados_programa::numeric(
                15, 2
            ) as valor_documentos_habeis_gerados_programa,
            valor_obs_geradas_programa::numeric(15, 2) as valor_obs_geradas_programa,
            valor_disponibilidade_atual_programa::numeric(
                15, 2
            ) as valor_disponibilidade_atual_programa,
