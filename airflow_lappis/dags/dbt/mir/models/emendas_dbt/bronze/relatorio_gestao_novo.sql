...
with
    relatorio_gestao_novo_raw as (
        select
            ...
            as data_e_hora_relatorio_gestao_novo,
            tipo_relatorio_gestao_novo::text as tipo_relatorio_gestao_novo,
            valor_executado_relatorio_gestao_novo::numeric(
                15, 2
            ) as valor_executado_relatorio_gestao_novo,
            valor_pendente_relatorio_gestao_novo::numeric(
                15, 2
            ) as valor_pendente_relatorio_gestao_novo,
