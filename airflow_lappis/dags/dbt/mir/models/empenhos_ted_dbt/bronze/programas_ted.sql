...
with
    programas_raw as (
        select
            ...
            sigla_unidade_responsavel_acompanhamento::text
            as sigla_unidade_responsavel_acompanhamento,
            unidade_responsavel_acompanhamento::text
            ...
            nullif(in_grupo_investimento_servico, '')::boolean
            as in_grupo_investimento_servico,
            nullif(in_grupo_investimento_equipamento, '')::boolean
            as in_grupo_investimento_equipamento,
            in_autoriza_subdescentralizacao_outro::text
            as in_autoriza_subdescentralizacao_outro,
            in_autoriza_realizacao_despesas::text as in_autoriza_realizacao_despesas,
            in_autoriza_execucao_creditos_descentralizada::text
            as in_autoriza_execucao_creditos_descentralizada,
